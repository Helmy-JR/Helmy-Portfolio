...
const projects = [
  {
    ...
    details:
      "Built with a clean, layered architecture applying Repository, Unit of Work, and Specification patterns to ensure scalability and maintainability. Supports JWT-based authentication, role-based access control, and structured business logic to deliver a reliable and extensible backend system.",
    github: "https://github.com/Helmy-JR/Talabat-APIs",
  },
  {
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
      viewBox="0 0 24 24" fill="none" stroke="currentColor"
    ...
    title: "Optima – Assistance App for the Visually Impaired",
    description:
      "Backend for a mobile application that connects visually impaired users with volunteers for real-time support. Provides RESTful APIs for user authentication, call request handling, session management, and secure video calls powered by Twilio.",
    technologies: [
      "JavaScript",
      "Express.js",
      "MongoDB",
    ...
    details:
      "Implements a queue-based matching system to connect help seekers with available volunteers, ensuring fair distribution of requests. Designed with scalable architecture, role-based access control, and real-time interaction handling. Emphasizes accessibility, reliability, and security to deliver a seamless live assistance experience.",
    github: "https://github.com/Optima-Dev/Optima-API",
  },
  {
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"   
      viewBox="0 0 24 24" fill="none" stroke="currentColor"   
    ...
    description:
      "Secure expense tracking API designed with Node.js, Express, and MongoDB, featuring JWT authentication, Google OAuth login, and role-based access control. Provides full CRUD support for expense records along with summaries, analytics, and recent activity tracking.",
    technologies: [
      "Node.js",
      "Express.js",
      "MongoDB",
    ...
    details:
      "Built with a modular architecture and Joi validation to ensure clean and reliable data handling. Integrated with Swagger for interactive API documentation, enabling easy testing and collaboration. Deployed on Render, offering experience in deploying, scaling, and managing production-ready backends.",
    github: "https://github.com/Helmy-JR/Expenses-Tracker",
  },
  {
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"     
      viewBox="0 0 24 24" fill="none" stroke="currentColor"     
    ...
    title: "Natours API 🌍",
    description:
      "Modular tour booking backend, developed with Node.js, Express, and MongoDB/Mongoose, structured with MVC and RESTful architecture. Supports user roles, authentication and authorization with JWT, booking management, reviews, geospatial queries, and server-side rendering with Pug.",
    technologies: [
      "Node.js",
      "Express.js",
      "MongoDB",
    ...
    github: "https://github.com/Helmy-JR/Natours-API",
  },
];
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const CONFIG = {
    typing: {
      ...
      eraseSpeed: 30,
      pauseDuration: 2000,
      text: "Hi, I'm Abdelrahman Helmy , Backend Developer.",
    },
    skills: {
      visibleCount: 10,
    },
